...
conf = {
    ...
    "insert_sql": "insert into bdidx_tbs_Indexes(FIDXID,FCRAWLID,FAREANM,FKEYWORD,FIDXDTKEY,FIDXVAL, FCREATEDT, FLASTUPDDT, FIDXDT) values (:1,:2,:3,:4,:5,:6, sysdate, sysdate, sysdate)"
}